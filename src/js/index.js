/*
By: Kelvin Araújo Ferreira
PASSO A PASSO DA "LOGICA" DA POKEDEX
...
pra isso vamos precisar trabalhar com dois elementos (as classes do html/css)
1 - listagem
2 - cartão do pokémon

precisamos criar duas variáveis no JS pra trabalhar com os elementos que vão estar na tela

- remover a classe aberto só do cartão que está aberto
- ao clicar em um pokémon da listagem pegamos o id desse pokémon pra saber qual cartão mostrar
-remover a classe ativo que marca o pokémon selecionado (Essa classe está inserida no pikachu)
